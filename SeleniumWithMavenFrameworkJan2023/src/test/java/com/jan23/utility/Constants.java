...
public class Constants {
	...
	public static final String STUDENT_REGISTRATION_PROPERTIES=USER_DIR+"/src/test/resources/testdataPropertyfiles/testDataForStudentRegistartion.properties";
